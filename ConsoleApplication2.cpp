...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	auto tournamentMin = pop.tournamentMin(2);
	auto tournamentMax = pop.tournamentMax(2);
	auto tournamentReturnMax = pop.tournamentReturnMax(2);
	auto tournamentReturnMin = pop.tournamentReturnMin(2);
